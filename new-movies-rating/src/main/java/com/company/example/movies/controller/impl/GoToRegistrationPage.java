...
public class GoToRegistrationPage implements Command {
    ...
    private static final Logger logger= LoggerFactory.getLogger(GoToRegistrationPage.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logger.error("ошибка при попытке перейти на registrationPage.jsp", e);
        }
    }
}
